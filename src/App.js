...
export default function App() {
  ...
  integrity="sha512-Z+TkAfv0Pd+SogRIq+FVRNtdxqPKCOyAPBb8V6Qcp0DQz84VQ6R9DLXvS2X2lPOwIp3K1M9kxgZtR0OZcKE2kg=="
      ...
      <style>{`
        ...
        * {
        ...
        @media (max-width: 768px) {
          ...
          footer {
  background-color: #1e1e1e; /* Matches --card-bg for visual consistency */
  color: var(--text);
...
@media (max-width: 600px) {
  ...
  <div className="footer-container">
    <div className="footer-content">
      ...
      <ul className="footer-links">
        ...
        <li>
          <a href="tel:+21612345678">
            <i className="fas fa-phone-alt"></i> +216 12 345 678
          </a>
        </li>
        <li>
      ...
      <p className="copyright">&copy; {new Date().getFullYear()} Yacine. All rights reserved.</p>
    </div>
  </div>
</footer>
