...
export default function App() {
  ...
  const projects = [
    ...
    {
      title: "Smart Shutdown Timer",
      description:
        "A lightweight and user-friendly desktop application built entirely with Python and Tkinter. This open-source tool allows you to schedule automatic shutdowns of your computer after a specified countdown timer. Perfect for managing system uptime, saving energy, or setting reminders to take breaks. Fully customizable, simple interface, and easy to use — all source code is available on my GitHub for anyone to explore or contribute!",
      url: "indexx.html",
    },
    {
...
@media (max-width: 768px) {
  ...
  <div class="footer-container">
    ...
    <div class="footer-section">
      <h3>À propos</h3>
      <p class="apropos">
        I’m a passionate software engineering student focused on building elegant and efficient web applications. I enjoy exploring new technologies and solving real-world problems through code.
      </p>
    </div>
    ...
    <div class="footer-section">
      <h3>Contact</h3>
      <p><i class="fas fa-phone-alt"></i> +216 99 999 999</p>
      <p><i class="fas fa-envelope"></i> contact@studyabroadtn.com</p>
      <div class="social-icons">
        <a href="https://instagram.com/yourusername" target="_blank" aria-label="Instagram">
          <i class="fab fa-instagram"></i>
        </a>
        <a href="https://wa.me/21699999999" target="_blank" aria-label="WhatsApp">
  ...
  <div class="footer-credit">
    &copy; 2025 StudyAbroadTN. Tous droits réservés.
  </div>
</footer>
